<?php
namespace d1soft\filemanager\widgets;

use Yii;
use yii\helpers\Html;
use yii\widgets\InputWidget;
use d1soft\filemanager\assets\FileInputAsset;
use yii\helpers\Url;
 ...
 * More samples of usage see on github: https://github.com/d1soft/yii2-filemanager
 *
 * @package d1soft\filemanager\widgets
...
class FileInput extends InputWidget
{
    ...
    public function run()
    {
        ...
        $modal = $this->renderFile('@vendor/d1soft/yii2-filemanager/views/file/modal.php', [
